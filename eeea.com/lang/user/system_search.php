...
$search_data=
    array(
        ...
        '添加内容栏目'=>'/index.php?case=table&act=add&table=category&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '幻灯'=>'/index.php?case=config&act=system&set=slide&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '批量改价'=>'/index.php?case=table&act=list&table=archive&shopping=1&admin_dir='.get('admin_dir',true).'&site=default',
        ...
        '批量打印'=>'/index.php?case=table&act=list&table=orders&admin_dir='.get('admin_dir',true).'&site=default',
