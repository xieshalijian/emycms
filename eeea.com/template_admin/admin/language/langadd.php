...
<div class="main-right-box">
 ...
 <input  name="submit" value="1" type="hidden">
            ...
            <div class="row">
                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right">{lang_admin('copy_content')}</div>
                <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
                    {form::getform('langcopy',$form,$field,$data,'class="form-control"')}
                    <p class="tips-p">{lang_admin('choose_to_copy_default_data_in_other_languages_the_replication_process_needs_to_wait')}</p>
                    <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="{lang_admin('please_fill_in_the_language_file_name')}"></span>
                </div>
            </div>
            <div class="clearfix blank20"></div>
            ...
            <div class="row">
                ...
                <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
                    ...
                    <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="{lang_admin('language_icons')}"></span>
                </div>
            </div>
            <div class="clearfix blank20"></div>
