...
<input type="hidden" name="pid" id="pid" value="<?php echo intval(front::get('pid'));?>" />
  <div id="tagscontent" class="right_box">
      ...
      <tr class="s_out" >
        <td width="19%" valign="top" align="right">{lang_admin('mold')}</td>
        <td width="1%">&nbsp;</td>
...
<div class="img_upload">
			...
			<dl>
				<div class="blank10"></div>
				<dd style='position:relative;'>
					<textarea name="intro" class="textarea"  value="{$data['intro']}" placeholder="{lang_admin('please_fill_in_the_description')}"></textarea><span class="hotspot" onmouseover="tooltip.show('{lang_admin('description_content_will_not_be_displayed_when_multitext_content_is_displayed')}');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
				</dd>
			</dl>
            <?php
			}
		...
		<div class="caidantype_4" style="display:{if $data['typeid']!=4}none{/if}">
			<dl>
				...
				<dd>
				<a href="#" onclick="gotourl(this)"   data-dataurl="javascript:void();" onclick="return weixin_adddisplayimg();">{lang_admin('adding_graphic_content')}</a>
