  ...
  <div id="tagscontent" class="right_box">
      ...
      <tr class="s_out" >
        ...
        <td width="70%" id="caidanbox">
            <select name="typeid" id="typeid" onchange="changetype()" class="select">
		...
		<dl>
			...
			<dd>
				<textarea name="txt" class="textarea gens nonull" value="{$data['txt']}" placeholder="{lang_admin('please_fill_in_the_reply')}" >{$data['txt']}</textarea><span class="hotspot" onmouseover="tooltip.show('{lang_admin('wechat_can_identify_the_phone_number_and_support_direct_dialing_by_clicking_on_the_phone_number')}');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
			</dd>
		</dl>
		</div>
...
<div class="img_upload">
			...
			<dl>
				<div class="blank10"></div>
				<dd style='position:relative;'>
					<input name='twname[]' type='text'  class="form-control"  value='{$tmp[0]}' class="form-control" placeholder="{lang_admin('please_fill_in_the_title')}"  /><span class="hotspot" onmouseover="tooltip.show('{lang_admin('please_fill_in_the_title')}');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
				</dd>
			</dl>
			<dl>
				<div class="blank10"></div>
				<dd style='position:relative;'>
				<input name='twurl[]' type='text' value='{$tmp[1]}'  class="text nonull input" placeholder="{lang_admin('please_fill_in_the_url')}" /><span class="hotspot" onmouseover="tooltip.show('{lang_admin('please_fill_in_the_url')}');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
				</dd>
			</dl>
            <?php
			if($i == 1){
