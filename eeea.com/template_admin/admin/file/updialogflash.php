...
<head>
    ...
    <title>{lang_admin('choose_video')}</title>
    ...
    <script type="text/javascript" language="JavaScript">
        ...
        var digheight="460";
        var rootDIR="";
        var fileview="index.php?case=file&act=netfileflash&admin_dir=<?php echo config::getadmin('admin_dir');?>";
        ...
        function refile(filename,iswidth,alt,width,height){
            ...
            }else if(checkfrom=='flashshow'){
                refileFlash(filename,alt,width,height);
        ...
        function refileFlash(filename,alt,width,height){
            parent.refileFlash(filename,alt,width,height);
        }
...
<div class="centerrightwindow">
    <div id="mainwindowtab">
        <ul>
            ...
            <li id="tabbottonul2" href="#" onclick="gotourl(this)"   data-dataurl="#body" onmousedown="javascript:windowsclass('#tabbottonul2','#tabcontentdiv2','tabbottonul','tabcontentdiv',2,4,'hover','hover2');flushiframe('netpic');">{lang_admin('network_video')}</li>
        </ul>
    </div>
    <div id="mainwindowstr">
        <div id="tabcontentdiv1" class="displaytrue"><iframe name="upfilewindow"  src="index.php?case=file&act=upfileflash&admin_dir=<?php echo config::getadmin('admin_dir');?>" width="100%" height="465" scrolling="no" frameborder="0" marginheight="0" marginwidth="0"></iframe></div>
        <div id="tabcontentdiv2" class="displaynone"><iframe name="netpic" id="netpic" src="" width="100%" height="465" scrolling="no" frameborder="0" marginheight="0" marginwidth="0"></iframe></div>
    </div>
</div>
<!-- {getCopyRight()} -->
</body>
