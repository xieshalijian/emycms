...
<head>
    ...
    <title>{lang_admin('network_flash')}</title>
...
<body class="bodyflow">
<form name="upfile" id="upfile" method="post" action="index.php?case=file&act=netfilesaveflash&admin_dir={get('admin_dir',true)}" onsubmit="return returnform(this);">
                ...
                <table class="formtablewin">
                    <tr class="trstyle2">
                        ...
                        <td class="trtitle02" id="upfilepath"><input type="text" name="upfilepath" maxlength="200" size="30" class="infoInput  form-control">
                            {lang_admin('please_fill_in_the_website')}</td>
                    </tr>
                    <tr class="trstyle2">
                        <td class="trtitle01"></td>
                        <td class="trtitle02" id="upfilepath">
                            {lang_admin('must_start_with_http')}：<input type="checkbox" name="autoplay" id="autoplay" value="1" />
                            {lang_admin('automatic_playback')}
                    ...
                    <td id="center">
                        <table border="0" style="margin: 0 auto;">
                            <tr >
                                ...
                                <td><input type="submit"  id="submitbotton" value="{lang_admin('confirm_to_add_files')}" class="buttonface" title="{lang_admin('confirm_to_add_files')}"/></td>
                                <td>&nbsp;&nbsp;</td>
