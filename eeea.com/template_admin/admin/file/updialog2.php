...
<script type="text/javascript" language="JavaScript">
	...
	var digheight="460";
	var rootDIR="";
	var fileview="index.php?case=file&act=netfile2&admin_dir=<?php echo config::getadmin('admin_dir');?>";
...
<div class="centerrightwindow">
	...
	<div id="mainwindowstr">
		<div id="tabcontentdiv1" class="displaytrue"><iframe name="upfilewindow"  src="index.php?case=file&act=upfile3&admin_dir=<?php echo config::getadmin('admin_dir');?>" width="100%" height="465" scrolling="no" frameborder="0" marginheight="0" marginwidth="0"></iframe></div>
