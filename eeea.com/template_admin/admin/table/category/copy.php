...
<div class="main-right-box">
    <div class="box edit-category" id="box">
        <form method="post" name="form1" action="<?php $id=''; echo modify("/act/add/table/".$table);?>"  onsubmit="return checkform(this);">
            <input type="hidden" name="onlymodify" value=""/>
            <h5>

                <?php if($shopping  && file_exists(ROOT."/lib/table/shopping.php")){ ?>
                    <?php echo lang_admin('copy_shopping_column');?>
                <?php }else{ ?>
                    <?php echo lang_admin('copy_content_column');?>
                <?php } ?>
                <!--工具栏-->
            ...
            <div class="row" style="display: none;">
                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right"><?php echo lang_admin('copy_mode');?></div>
                <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
                    <input name="addtype" value="single"  type="radio" checked="checked" onclick="stob(this.value)" />
                    <?php echo lang_admin('single_copy');?>
                </div>
            </div>
            <!--所属栏目-->
            ...
            <div class="tab-content">
                <!-- 信息 -->
                <div role="tabpanel" class="tab-pane" id="tag1">
                    <!-- 封面内容 -->
                    <div class="row">
                ...
                <!-- SEO -->
                <div role="tabpanel" class="tab-pane active" id="tag2">
                    <!-- 网页标题 -->
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right">
                            <span class="icon-note"></span>&nbsp;<?php echo lang_admin('page_description');?>
                        </div>
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
                ...
                <div role="tabpanel" class="tab-pane" id="tag6">
                    <?php if(is_array($field))
                        foreach($field as $f) { ?>
                            ...
                            setting::$var['category'][$name]['catid_'.$adminlang]=isset(setting::$var['category'][$name]['catid_'.$adminlang])?setting::$var['category'][$name]['catid_'.$adminlang]:"";
...
//	alert('Error loading XML document');
    ...
    $(function() {
      ...
      /*  $("#catname").mouseleave(function(){
            ...
            if (catname!="<?php echo $data['catname'];?>"){
