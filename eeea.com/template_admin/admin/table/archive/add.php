...
<style type="text/css">
    @media(max-width:468px) {
        ...
        .add-content .text-left {margin:0px; padding:0px 5px;}
    }
...
if($shopping && file_exists(ROOT."/lib/table/shopping.php")){
    ...
    <div class="main-right-box">
        <div class="box add-content" id="box">
            <h5><?php if($shopping  && file_exists(ROOT."/lib/table/shopping.php")){ ?>
            ...
            <?php if($shopping  && file_exists(ROOT."/lib/table/shopping.php")){ ?>
                <div class="row">
                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right"><span class="icon-note"></span> <?php echo lang_admin('column');?>
                    </div>
                ...
                <div class="col-xs-8 col-sm-7 col-md-7 col-lg-7 text-left">
                    <div class="input-group">
                        ...
                        <?php echo lang_admin('thickening');?>
                            <input name="strong" type="checkbox" value="1" <?php if(isset($data['strong']) && $data['strong']==1) { ?>checked<?php } ?> />
                    </span>
                    </div>
                </div>
            </div>
            ...
            <?php if($shopping  && file_exists(ROOT."/lib/table/shopping.php")){ ?>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
                        <input type="number" name="inventory" id="inventory" value="" class="form-control " onkeyup="value=(parseInt((value=value.replace(/\D/g,''))==''?'0':value,10))">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
                        <input type="number" name="salesnum" id="salesnum" value="" class="form-control " onkeyup="value=(parseInt((value=value.replace(/\D/g,''))==''?'0':value,10))">
                        <span class="tips" data-toggle="tooltip" data-html="ture" data-placement="right" title="<?php echo lang_admin('please_fill_in_numeric_characters_greater_than_0');?>"></span>
                    </div>
                </div>
                <div class="clearfix blank20"></div>
                ...
                <div class="row">
                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right">
                        <a class="btn btn-gray"><?php echo lang_admin('price');?></a>
                    </div>
                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
                    </div>
                </div>
                ...
                if(is_array($langdata)){
                    ...
                    foreach ($langdata as $key=>$value){
                        ...
                        <div class="row" style="<?php echo $show_pice_style;?>">
                            <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right"><?php echo $value['langname'];?></div>
                            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
                                <input type="number" name="<?php echo $newcname;?>" id="<?php echo $newcname;?>" value="0" class="form-control " onkeyup="value=(parseInt((value=value.replace(/\D/g,''))==''?'0':value,10))">
                                <span class="tips" data-toggle="tooltip" data-html="ture" data-placement="right" title="<?php echo lang_admin('please_fill_in_numeric_characters_greater_than_0');?>"></span>
                            </div>
                        </div>
                ...
                <div role="tabpanel" class="tab-pane" id="tag3">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
                            <div id="uploadarea">
                                ...
                                <div style="border: 1px dashed #ccc;border-radius:3px;">
                                    <a title="<?php echo lang_admin('select_files');?>" onclick="javascript:windowsdig('<?php echo lang_admin('select_files');?>','iframe:index.php?case=file&act=updialog&fileinputid=pics&getbyid=pvpics&max=99&checkfrom=piclistshow&admin_dir=<?php echo config::getadmin('admin_dir');?>','900px','480px','iframe')" href="#body"><p><img src="<?php echo $base_url;?>/common/js/ajaxfileupload/pic.png" style="width:90px;" /></p></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
                            ...
                            <?php echo lang_admin('route');?>：<input type="text" name="attachment_path" class="form-control"  id="attachment_path" value="" />
                            <span class="tips icon-info" data-toggle="tooltip" data-html="ture" data-placement="right" title="<?php echo lang_admin('fill_in_this_form_without_uploading_the_attachment_please_fill_in_the_complete_url_address');?>"></span>
                            <div class="blank10"></div>
                ...
                <div role="tabpanel" class="tab-pane" id="tag5">
                    ...
                    <script>
                        function  load_filter(catid) {
                            var url='{url("filter/getfilter_option")}'+'&catid='+catid;
                            $.ajax({
                                type: "get",
                                url: url,
                                async: false,
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5 text-left">
                                <div class="form-inline">
                                    <?php
                                    $data['province_id']=isset($data['province_id'])?$data['province_id']:"";
                                    $data['city_id']=isset($data['city_id'])?$data['city_id']:"";
                                    $data['section_id']=isset($data['section_id'])?$data['section_id']:"";
                                    echo form::select('province_id',$data['province_id'], area::province_option()); ?>
                                    <?php echo form::select('city_id', $data['city_id'],
                                        area::city_option($data['city_id'],$data['province_id'])); ?>
                ...
                <div role="tabpanel" class="tab-pane" id="tag6">
                    ...
                    <?php if(is_array($fieldzdy))
                        foreach($fieldzdy as $f) { ?>
                            ...
                            $data['catid']=isset($data['catid'])?$data['catid']:"";
                            ...
                            if (!isset($data[$name]))
                                $data[$name]='';
                            setting::$var['archive'][$name]['istage']=isset(setting::$var['archive'][$name]['istage'])?setting::$var['archive'][$name]['istage']:"";
                            ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-8 col-md-9 col-lg-10 text-left">
                                    ...
                                    <input type="submit" value="<?php echo lang_admin('newly_added');?>" name="restore"
                                           onclick="
                                                   this.form.action='<?php echo url('field/add/table/archive/shopping/'.$shopping,true);?>';
                                                   this.form.batchmediumtext.value='addmediumtext'; $('#form1').attr('onsubmit','return checkform2(this)');" class="btn btn-gray" />
                                </div>
                            </div>
                        </div>
                        <!-- 商品自定义字段 -->
                            ...
                            <?php if(is_array($field))
                                foreach($field as $f) { ?>
                                    ...
                                    if (!isset($data[$name]))
                                        $data[$name]='';
                                    ?>
                                    <?php if( (isset(setting::$var['archive'][$name]['isshoping']) && setting::$var['archive'][$name]['isshoping'] == '1')  && (isset(setting::$var['archive'][$name]['isbuyurl']) && setting::$var['archive'][$name]['isbuyurl'] != '1') ){?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="product_table">
                                            <tr>
                                                ...
                                                <td><span><?php echo lang_admin('add_time');?></span></td>
                                                <td class="text-center"><span><?php echo lang_admin('dosomething');?></span></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <input type="text"  name="product_code_1" value="" class="form-control">
                                                </td>
                                                <td>
                                                    <?php echo form::date("product_outtime_1", "");?>
                                                </td>
                                                <td>
                                                    <?php echo form::date("product_addtime_1", "");?>
                                                </td>
                                                <td class="text-center">
                                                    <a onclick="delete_product(this,1,false)"  class="btn btn-gray"><?php echo lang_admin('delete');?></a>
                                                </td>
                                            </tr>
                                        </table>
...
<!-- 当前页面的js -->
<script type="text/javascript" src="<?php echo $base_url.'/template_admin/'.front::$view->_style;?>/table/archive/add.js"></script>
<script type="text/javascript">
    //组合商品
...
//保存购买链接
    ...
    function add_product() {
        ...
        html+="$('#product_outtime_"+product_i+"').datepicker(";
        html+="{";
        ...
        html+="<script language='javascript'>";
        html+="$(document).ready(function(){" ;
        html+="$('#product_addtime_"+product_i+"').datepicker(";
        html+="{";
        html+="dateFormat: 'yy-mm-dd'," ;
        html+="autoSize:true," ;
        html+="buttonImage: '/images/calendar.png',";
        ...
        html+=");";
        html+="<\/script>";
        html+='<input type="text" name="product_addtime_'+product_i+'" id="product_addtime_'+product_i+'" value="" class="form-control hasDatepicker">';
        html+='<img class="ui-datepicker-trigger" src="/images/calendar.png" alt="请选择日期" title="请选择日期">';
        html+='</td>';
...
<script type="text/javascript">
    ...
    function get_field(catid) {
        $.ajax({
            url: '<?php echo url('table/getfield/table/archive/aid/0',true);?>&catid='+catid,
            type: 'GET',
            dataType: 'text',
            timeout: 10000,
            success: function(data){
