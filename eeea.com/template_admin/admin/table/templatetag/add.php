<div class="main-right-box">
    ...
    <div class="box" id="box">
        ...
        <a href="#" onclick="gotourl(this)"   data-dataurl="{$base_url}/index.php?case=table&act=list&table=templatetag&tagfrom=announcement&admin_dir={get('admin_dir',true)}&site=default" class="btn btn-default" data-dataurlname="<?php echo lang_admin('template_label_list');?>">
                        <i class="icon-action-redo"></i>
                    </a>
...
{form::getform('remarksname',$form,$field,$data)}
