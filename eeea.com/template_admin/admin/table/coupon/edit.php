...
<div class="row">
    ...
    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
       <!-- <input type="text" name="couponrange" id="couponrange" value="0:0"  style="display: none" class="form-control">-->
        ...
        {form::getform('couponrange',$form,$field,$data)}
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
    {form::getform('adddatatime',$form,$field,$data)}
...
$(function(){
    $('#couponrange').attr("style","display: none");
    if($("#overlay").val()=='0'){
        $("#overlay").attr("disabled","disabled");
    }
    $("#adddatatime").attr("disabled","disabled");
