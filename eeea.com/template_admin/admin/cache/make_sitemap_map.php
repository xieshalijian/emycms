    ...
    <div class="box" id="box">
        ...
        <div class="cache-html">
                ...
                <div class="alert alert-warning alert-dismissible" role="alert">
                    ...
                    <span class="glyphicon glyphicon-warning-sign"></span>	 <strong>{lang_admin('generate_site_map')} {lang_admin('address')}</strong>	<a href="{get('site_url')}index.php?case=archive&act=sitemap" target="_blank">{get('site_url')}sitemap/index-{lang_admin('language')}.html</a>
                </div>
                    ...
                    <div class="line"></div>
                    <div class="blank30"></div>
                    <a class="btn btn-primary btn-lg" href="#" onclick="gotourl(this)" data-dataurl="{$base_url}/index.php?case=cache&act=ctsitemap">
                        {lang_admin('generate')}
                    </a>
