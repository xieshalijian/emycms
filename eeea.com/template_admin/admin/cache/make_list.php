<?php if(config::getadmin('list_page_php')=='1')  { ?>
...
<div class="main-right-box">
    <h5>{lang_admin('column_generation_html')}</h5>
    <div class="box" id="box">
        ...
        <div class="cache-html">
            <div class="col-xs-12 col-sm-5 col-md-3 col-lg-3 pull-left cache-html-side">
                ...
                <a class="active" href="#" onclick="gotourl(this)"   data-dataurl="{$base_url}/index.php?case=cache&act=make_list&admin_dir={get('admin_dir',true)}&site=default" data-dataurlname="{lang_admin('column_generation_html')}">
            ...
            <div class="col-xs-12 col-sm-7 col-md-9 col-lg-9 pull-right cache-html-content">
                ...
                <form name="listform" method="post" action="<?php echo front::$uri;?>" onsubmit="return returnform(this);">
        ...
        <div class="main-right-box">
            ...
            <div class="box" id="box">
                <div class="alert alert-danger" role="alert">
                    ...
                    {lang_admin('column_usage_static_is_not_set')}， <a href="#" onclick="gotourl(this)" data-dataurl="<?php echo $base_url;?>/index.php?case=config&act=system&set=dynamic&admin_dir=<?php echo get('admin_dir',true);?>&site=default" data-dataurlname="<?php echo lang_admin('dynamic');?>" class="btn btn-info">
...
<?php if (session::get("cahe_make_list")){?>
    <div class="cache-box">
    <div class="cache-view" >
        <h3 class="autotype">{lang_admin('being_generated')}： </h3>
        <iframe name="view" id="view"  src="<?php echo url::create('cache/make_list/getshowstatic/1'); ?>" width="100%" height="180" color="#fff"></iframe>
        <div class="blank30"></div>
    </div>
    </div>
<?php };?>
