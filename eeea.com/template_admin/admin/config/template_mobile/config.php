    ...
    <form method="post" action="<?php echo uri();?>" name="config_form" id="config_form" onsubmit="return returnform(this);">
        <div class="main-right-box">
            ...
            <h5>                   <?php echo lang_admin('template_mobile_dir');?>                           <!--工具栏-->
            ...
            <div id="content-eidt-nav"></div>
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <?php if(config::getadmin('mobile_open')==1) { ?>
                        <li role="presentation" class="tag_template_mobile  active">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="tag1" name="tagdiv">
                    ...
                    <div class="tempalte-list">
                                    ...
                                    <div class="tempalte-box">
                                        ...
                                        <div class="tempalte-btn">
                                            <div class="col-xs-6">
                                                <div class="row">
                                                    <button   type="submit"
                                                        <?php if(trim($data['template_mobile_dir'])==trim($template_mobile_val['remark_name']) ) { ?>
                                                        ...
                                                        <?php } elseif ($data['template_mobile_dir']!=$template_mobile_val['remark_name']) { ?>
                        ...
                        <div class="blank10"></div>
                        <?php echo form::hidden("template_mobile_dir",$data['template_mobile_dir']);?>
