        ...
        <form method="post" action="<?php echo uri();?>" name="config_form" id="config_form" onsubmit="return returnform(this);">
            <div class="main-right-box">
                ...
                <h5>                   <?php echo lang_admin('commodity_template');?>                           <!--工具栏-->
            ...
            <div id="content-eidt-nav"></div>
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <?php if(file_exists(ROOT."/lib/table/shopping.php")){ ?>
                            <li role="presentation" class="tag_template_shopping active">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="tag1" name="tagdiv">
                    ...
                    <div class="tempalte-list">
                                    ...
                                    <div class="tempalte-box">
                                        ...
                                        <div class="tempalte-btn">
                                            <div class="col-xs-6">
                                                <div class="row">
                                                    <button   type="submit"
                                                        <?php if(trim($data['template_shopping_dir'])==trim($template_shop_val['remark_name']) ) { ?>
                                                        ...
                                                        <?php } elseif ($data['template_shopping_dir']!=$template_shop_val['remark_name']) { ?>
                        ...
                        <div class="blank10"></div>
                        <?php echo form::hidden("template_shopping_dir",$data['template_shopping_dir']);?>
