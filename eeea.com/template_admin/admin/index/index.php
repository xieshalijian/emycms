        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">{lang_admin('view_the_license_agreement')}</h4>
                </div>
                <div class="modal-body" style="max-height: 300px;">
                    {template_admin 'index/license.php'}
                </div>
                <div class="modal-footer">
                    <input type="checkbox"  name="license_pass" checked=""><label for="readpact"></label>&nbsp;
                    <button type="button" class="btn btn-default" id="config_agreement">{lang_admin('i_have_read_and_agreed_to_this_agreement')}</button>
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">{lang_admin('disagree')}</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div>
