...
<?php if(config::getadmin('wap_show_page_php')=='1')  { ?>
<style type="text/css">
    ...
    <div class="box" id="box">
        ...
        <div class="cache-html">
            <div class="col-xs-12 col-sm-5 col-md-3 col-lg-3 pull-left cache-html-side">
                ...
                <a class="active" href="#" onclick="gotourl(this)"   data-dataurl="{$base_url}/index.php?case=wapcache&act=make_show&admin_dir={get('admin_dir',true)}&site=default" data-dataurlname="{lang_admin('mobile_content_generation')} Html">{lang_admin('mobile_content_generation')}</a>
                ...
                <form name="aidform" method="post" action="<?php echo front::$uri;?>" onsubmit="return returnform(this);">
                    <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
                            ...
                            echo " <div class='col-xs-1 col-sm-1 col-md-1 col-lg-1'>ID：</div><div class='col-xs-5 col-sm-5 col-md-5 col-lg-5'>".form::input('aid_start',$aid['min']);
...
<?php if (session::get("cahe_wap_make_show")){?>
    <div class="cache-box">
        <div class="cache-view" >
            <h3 class="autotype">{lang_admin('being_generated')}： </h3>
            <iframe name="view" id="view"  src="<?php echo url::create('wapcache/make_show/getshowstatic/1'); ?>" width="100%" height="180" color="#333"></iframe>
            <div class="blank30"></div>
        </div>
    </div>
<?php };?>
            ...
            var timer = setInterval(function() {
                ...
                if(index >= str.length){
                    setTimeout(function(){//3秒后跳转
                        gotoinurl('{url("wapcache/make_show")}');
                    },3000);
                    clearInterval(timer);
