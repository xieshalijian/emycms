<div class="main-right-box">
    <h5>{lang_admin('voting_options')}</h5>
            ...
            <div id="tagscontent">
                <div id="con_one_1">
                    <div class="table_td" style="margin-top:10px; ">
                        ...
                        <form method="post" name="form1" action="<?php if(front::$act=='edit') $id="/id/".$data[$primary_key]; else $id=''; echo modify("/act/add/table/".$table.$id."/bid/".front::get('bid')."/type/dialog");?>"
                              onsubmit="return returnform(this);">
                            <table border="0" cellspacing="2" cellpadding="4" class="list" name="table" id="table" width="100%">
                                <thead>
                                <tr onmouseover="this.bgColor='#FFFFF0';" onmouseout="this.bgColor='';" bgcolor="">
                                    <th colspan="2">{lang_admin('adding_options')}</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr onmouseover="this.bgColor='#FFFFF0';" onmouseout="this.bgColor='';" bgcolor="">
                                    <td class="left">{lang_admin('option_name')}</td>
                            ...
                            <input type="submit"  value="{lang_admin('submitted')}" class="button"/>
                        </form>
