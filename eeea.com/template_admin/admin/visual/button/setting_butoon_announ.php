<span class="drag label btn-group drag-container">
    ...
    <button type="button" class="btn btn-gray" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <span>{langadmin_announ}</span>
    ...
    <ul class="dropdown-menu btn-black-dropdown-menu">
        ...
        <li>
            <a data-target="#template-announ-tag" role="button" data-toggle="modal">
