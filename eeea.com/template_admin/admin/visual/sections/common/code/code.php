...
<div class="lyrow element-box">
    ...
    <span class="drag label btn-group drag-container">
        ...
        <li>
            ...
            <li>
                <a data-target="#codeModel" role="button" data-toggle="modal">
                    <i class="glyphicon glyphicon-pencil"></i>
                    <?php echo lang_admin('edit_source_code');?>
                </a>
            </li>
            <!--设置按钮-->
        <li>
    ...
    <div class="preview">
        <img src="<?php echo $base_url;?>/template_admin/<?php echo get('template_admin_dir',true);?>/visual/sections/common/code/code.png">
        <p>{langadmin_source_code}</p>
    </div>
    <div class="view">
        <div class="tag">
            <span class="removeClean tagname">
                &#123;tag_sections_common_code_1&#125;
            </span>
            <!--组件演示开始-->
            {tag_sections_common_code_1}
            <!--组件演示结束-->
