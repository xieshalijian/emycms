...
<div class="lyrow element-box inline-block">
    ...
    <ul class="dropdown-menu btn-black-dropdown-menu">
        ...
        <li>
            <a data-target="#icon-config" role="button" data-toggle="modal">
                <i class="glyphicon glyphicon-pencil"></i>
                <span>{langadmin_select_icons}</span>
            </a>
        </li>
        <!--删除按钮-->
        <li>
    ...
    <div class="preview">
        <img src="<?php echo $base_url;?>/template_admin/<?php echo get('template_admin_dir',true);?>/visual/sections/common/icon/icon.png" alt="<?php echo lang_admin('icon');?>">
        <p>{langadmin_icon}</p>
    </div>
    <div class="view">
        <div class="tag inline-block">
            <span class="removeClean tagname">
                &#123;tag_sections_common_icon_1&#125;
            </span>
            <!--组件演示开始-->
            {tag_sections_common_icon_1}
            <!--组件演示结束-->
