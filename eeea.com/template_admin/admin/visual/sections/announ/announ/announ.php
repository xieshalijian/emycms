...
<div class="lyrow element-box position-move clearfix">
    ...
    <ul class="dropdown-menu btn-black-dropdown-menu">
        ...
        <!--列表样式-->
        <li>
            <a data-target="#template-list-tag" data-type="announ" role="button" data-toggle="modal">
    ...
    <div class="preview">
        <img src="<?php echo $base_url;?>/template_admin/<?php echo get('template_admin_dir',true);?>/visual/sections/common/announ/announ.png">
        <p><?php echo lang_admin('announcement');?></p>
    </div>
    <div class="view">
        <div class="tag">
            <span class="removeClean tagname">
                &#123;tag_sections_common_announ_1&#125;
            </span>
            <!--组件演示开始-->
            {tag_sections_common_announ_1}
            <!--组件演示结束-->
