    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <ul class="nav nav-tabs" role="tablist" name="navigation_modal_tabs_content">
            ...
            <div class="modal-body">
                ...
                <div class="tab-content" name="content_modal_show">
            ...
            <div class="modal-footer">
                ...
                <button name="savecontent" type="button" class="btn btn-primary" data-dismiss="modal"><?php echo lang_admin('preservation');?>
                </button>
            </div>
        </div>
    </div>
...
<div class="modal fade old-tag" id="template-old-content-tag" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="tag-content-config">
                    ...
                    <!-- 标签 -->
                    <div role="tabpanel" class="tab-pane" id="tag-content-template">
...
<script type="text/javascript">
    var currenteditor;
    var template_getcontent='<?php echo url("template/getcontent");?>';
    $(document).ready(function () {
        var isoldcontent=false;
        $('body.edit .visual-right').on("click", "[data-target='#template-content-tag']", function (e) {
            ...
            if(_tag_buymodules.test(eText) ||  _tag_modules.test(eText) )
            {
                ...
                $('#template-content-tag').addClass("modal-right");
                isoldcontent=false;
                ...
                $.post('<?php echo url("template/gettag");?>',{'tag':eText},function(res){
                    //弹出框
                    $('#template-content-tag').modal('hide');
                    console.log(res);
                    ...
                    $('#frmcontent .remarksname').val(res.setting.remarksname);
                ...
                $('#template-old-content-tag').modal('show');
            }

        });

        $('body.edit .visual-right').on("click", "[data-target='#template-old-content-tag']", function (e) {
            e.preventDefault();
            currenteditor = $(this).parent().parent().parent().parent().find('.view');
            var eText = currenteditor.find('.tagname').html();
                //打开的老的弹出框
        ...
        $("[name=tagimg]").click(function (e) {
            $("#frmcontent .tagtemplate").val($(this).data("tagname"));
        ...
        $("[name=savecontent]").click(function (e) {
            ...
            if (isoldcontent){
                ...
                $("input[name='tag-tabid-content']").each(function () {
                    var id = $(this).val();
                    if ($('#frmcontent' + id + ' [name=catid]').val() == '0') {
                        alert("<?php echo lang_admin('please_select_the_column');?>");
                        istab(id);
                        $('#frmcontent' + id + ' [name=catid]').focus();
                        return false;
                    }

                    data = $('#frmcontent' + id).serialize();
                    ...
                    $.post(savemoduletagurl, data, function (res) {
                        $('#frmcontent' + id)[0].reset();
                        $('#frmcontent' + id + ' .id').val('');
                        savemodule('frmcontent',id,res,currenteditor);
                        ready_all();
                    });
