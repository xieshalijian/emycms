<html>
<head>
<title>{lang_admin('insert_pictures')}</title>
  ...
  <table width="100%" border="0">
    ...
    <tr height="25">
      <td colspan="3" nowrap> <fieldset>
        <legend>{lang_admin('upload_pictures')}</legend>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table1">
          <tr height="30">
            ...
            <br><br>
              &nbsp; <input type="submit" name="picSubmit" id="picSubmit" value=" {lang_admin('upload')}  " style="height:22;" class="binput">
          </tr>
        </table>
        ...
        {loop $uploads $up}
          ...
          <tr height="30">
            <td align="right" nowrap>&nbsp;</td>
            <td colspan="2" nowrap>
            <script type="text/javascript">ImageOK('{$up}');</script>
              </td>
          </tr>
        </table>
        {/loop}
