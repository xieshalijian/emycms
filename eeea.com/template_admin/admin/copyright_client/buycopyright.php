            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="buy_copyright_domain"
                               id="buy_copyright_domain" placeholder="***" onkeyup="value=value.replace(/[^\w\.\/.*+%!-]/ig,'')" value="">
                    </div>
                </div>
...
<div class="main-right-box">
    ...
    <div class="box" id="box">
        ...
        <h5>
            ...
            <a class="btn btn-primary"  href="#" onclick="gotourl(this)"   data-dataurl="<?php echo url('app/close/copyright/1',true);?>" ><?php echo lang_admin('sign_out');?></a>
                ...
                <a href="#" onclick="gotourl(this)"   data-dataurl="<?php echo $base_url;?>/index.php?case=copyright_client&act=copyrightlist&admin_dir=<?php echo get('admin_dir',true);?>&site=default" data-dataurlname="<?php echo lang_admin('commercial_version');?>" class="btn btn-default"><?php echo lang_admin('yes_buy');?></a>
            <?php } else { ?>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="system_down text-center">
                ...
                <h4 class="desc"><?php echo $data['subtitle'];?></h4>
                ...
                <div class="shop-price">
                    <a  title="<?php echo lang_admin('purchase_authorization') ;?>" class="btn btn-license" data-toggle="modal"
                        ...
                        <?php echo lang_admin('commercial_version') ;?> ￥<span id="shop-price">
                            <?php   echo floatval($data['attr2'])*(($returndata['static'] && $returndata['userdata']['discount'])>0?$returndata['userdata']['discount']:10)/10; ?></span></a>
                    <div class="blank30"></div>

                    <a href="#" onclick="gotourl(this)" data-dataurl="<?php echo $base_url;?>/index.php?case=license_client&act=buylicense&admin_dir=<?php echo get('admin_dir',true);?>&site=default" data-dataurlname="<?php echo lang_admin('commercial_authorization');?>" class="btn btn-default">
                        如果您想去除版权标识&nbsp;&nbsp;<i class="glyphicon glyphicon-arrow-right"></i>
                    </a>
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingOne">
                            <h4 class="panel-title">
                                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="collapsed">
                                    <?php echo lang_admin('buy_business_one') ;?>
                                </a>
                            </h4>
                        </div>
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" aria-expanded="true" style="">
                            <div class="panel-body">
                                <p>
                                    <?php echo lang_admin('buy_business_one_info') ;?>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingThree">
                            <h4 class="panel-title">
                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    <?php echo lang_admin('buy_business_three') ;?>
                                </a>
                            </h4>
                        </div>
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree" aria-expanded="false">
                            <div class="panel-body">
                                <p>
                                    <?php echo lang_admin('buy_business_three_info') ;?>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingFour">
                            <h4 class="panel-title">
                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                    <?php echo lang_admin('buy_business_four') ;?>
                                </a>
                            </h4>
                        </div>
                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour" aria-expanded="false">
                            <div class="panel-body">
                                <p>
                                    <?php echo lang_admin('buy_business_four_info') ;?>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingFive">
                            <h4 class="panel-title">
                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                    <?php echo lang_admin('buy_business_five') ;?>
                                </a>
                            </h4>
                        </div>
                        <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive" aria-expanded="false">
                            <div class="panel-body">
                                <p>
                                    <?php echo lang_admin('buy_business_five_info') ;?>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingSix">
                            <h4 class="panel-title">
                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                    <?php echo lang_admin('buy_business_six') ;?>
                                </a>
                            </h4>
                        </div>
                        <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix" aria-expanded="false">
                            <div class="panel-body">
                                <p>
                                    <?php echo lang_admin('buy_business_six_info') ;?>
                                </p>
                            </div>
                        </div>
                    </div>
...
<script>
    $(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.static == 1) {
                        ...
                        $(".modal-backdrop.fade").hide();
                        gotoinurl("/index.php?case=copyright_client&act=buycopyright&admin_dir=<?php echo get('admin_dir');?>");
                    } else {
                        alert(data.message);
                    }
                }
        ...
        $('#btn_buy').click(function(){
            var  buy_domain=$("#buy_copyright_domain").val();     //域名
            if ($('#buy_copyright_domain').val() == '') {
                alert('请输入域名');
                $('#buy_copyright_domain').focus();
                return;
            }
            //关闭购买弹出框
            $('#buyModal').modal('hide');
            ...
            $.ajax({
                type: "get",
                url: "<?php echo url('app/buycopyright',true);?>",
                ...
                success: function (data) {
                    ...
                    if(data.static){
                        alert(data.message);
                        //购买成功
                        gotoinurl("/index.php?case=copyright_client&act=copyrightlist&admin_dir=<?php echo get('admin_dir');?>");
                    }else{
                        alert(data.message);
                        console.log(data);
                    }
