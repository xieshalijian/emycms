    ...
    <div class="main-right-box">
        <h5>
            ...
            <span class="pull-right">
                ...
                <a href="#" onclick="gotourl(this)" data-dataurl="<?php echo $base_url;?>/index.php?case=copyright_client&act=buycopyright&admin_dir=<?php echo get('admin_dir',true);?>&site=default" data-dataurlname="<?php echo lang_admin('commercial_authorization');?>" data-dataurlname="<?php echo lang_admin('commercial_version');?>" class="btn btn-danger">
                    <?php echo lang_admin('commercial_version');?>
                </a>
        ...
        <div class="box">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active">
                    <a href="#" onclick="gotourl(this)"   data-dataurl="<?php echo $base_url;?>/index.php?case=copyright_client&act=copyrightlist&admin_dir=<?php echo get('admin_dir',true);?>&site=default" data-dataurlname="<?php echo lang_admin('commercial_version');?>"  aria-controls="home" role="tab" data-toggle="tab">
                        <?php echo lang_admin('commercial_version') ;?>
                    </a>
                </li>
...
<?php } ?>
    ...
    <script>
        ...
        function downloadFile($f) {
            ...
            updateState("<?php echo lang_admin('start_downloading_copyright_files');?>");
            ...
            var def = $.get("<?php echo url('copyright_client/down/action/prepare-download',true);?>", {'f': filename}, null, 'json');
            def.then(function (res) {
                ...
                url = "<?php echo url('copyright_client/down/action/start-download',true);?>";
                ...
                var interval_id = window.setInterval(function () {
                    ...
                    if (progress >= 100) {
                        ...
                        // 到此远程文件下载完成，继续其他逻辑
                        updateState("<?php echo lang_admin('download_successful_start_to_install_the_copyright');?>");
                        $.ajax({
                            url : "<?php echo url('copyright_client/down/action/exzip',true);?>",
                            data: {'f': filename},
                            dataType:'json',
                            type : 'GET'
                        }).done(function(res){
                        ...
                        $.ajax({
                            url: "<?php echo url('copyright_client/down/action/get-file-size',true);?>",
                            data: {'f': filename},
                            dataType: 'json',
                            type: 'get'
                        }).done(function (json) {
