...
class weixinmenu_admin extends admin{
    ...
    function list_action(){
        if (front::post('submit')) {
            ...
            alertinfo(lang_admin('preservation').lang_admin('success'),url('weixinmenu/list/id/'.front::$post['wid'], true));
        }
    ...
    function add_action(){
        if (front::post('submit')) {
            ...
            if($this->db_weixinmenu->rec_insert($post)) {
                ...
                front::redirect(url('weixinmenu/list/id/'.$post['wid'], true));
            }else{
    ...
    function edit_action(){
        if (front::post('submit')) {
            ...
            if($this->db_weixinmenu->rec_update($post,intval($post['id']))) {
                ...
                alerterror(lang_admin('modify').lang_admin('failure'));
            }
        }
    ...
    function del_action(){
        ...
        if($this->db_weixinmenu->rec_delete($id)){
            front::redirect(url('weixinmenu/list/id/'.$wid, true));
        }else{
    ...
    function push_action(){
        ...
        $data['body'] = json_encode($buttons,JSON_UNESCAPED_UNICODE);
        //var_dump($data['body']);
        ...
        if($res['errcode']){
            ...
            alertinfo(lang_admin('release').lang_admin('success'),url('weixinmenu/list/id/'.$wid, true));
        }
        exit;
    }
