...
class weixinreply_admin extends admin{
    ...
    function added_action(){
        if (front::post('submit')) {
            ...
            if($this->db_weixinreply->rec_replace($post)) {
                ...
                front::redirect(url('weixinreply/added/wid/'.$post['wid'], true));
            }else{
    ...
    function msged_action(){
        if (front::post('submit')) {
            ...
            if($this->db_weixinreply->rec_replace($post)) {
                //$id = $this->db_weixinmenu->insert_id();
                front::redirect(url('weixinreply/msged/wid/'.$post['wid'], true));
            }else{
                alerterror(lang_admin('add_to').lang_admin('failure'));
            }
        }
    ...
    function add_action(){
        if (front::post('submit')) {
            ...
            if($this->db_weixinreply->rec_insert($post)) {
                //$id = $this->db_weixinmenu->insert_id();
                front::redirect(url('weixinreply/list/id/'.$post['wid'], true));
            }else{
                alerterror(lang_admin('add_to').lang_admin('failure'));
            }
        }
    ...
    function del_action(){
        ...
        if($this->db_weixinreply->rec_delete($id)){
            front::redirect(url('weixinreply/list/id/'.$wid, true));
        }else{
