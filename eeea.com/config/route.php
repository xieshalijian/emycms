...
array(
		...
		array('list-wap-(\d+)-(\d+)\.htm$','archive/list/catid/$1/page/$2/t/wap'),
		
		//内容
		array('show-wap-(\d+)\.htm$','archive/show/t/wap/aid/$1'),
		array('show-wap-(\d+)-(\d+)\.htm$','archive/show/t/wap/aid/$1/page/$2'),
    ...
    array('announ-show-(\d+)\.htm$','announ/show/id/$1'),
