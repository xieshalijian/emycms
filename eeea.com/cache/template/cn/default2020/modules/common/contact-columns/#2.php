...
<link href="<?php echo $template_path;?>/visual/modules/common/contact-columns/css/style-2.css" rel="stylesheet">


<div class="contact-columns-right contact-columns-right-2">
    <div class="contact-columns-right-bg-txt">
        <?php if(is_array(plugins::categoryinfo(10)))
foreach(plugins::categoryinfo(10) as $cat) { ?>
        <h4>
            <span cmseasy-id="<?php echo $cat['catid'];?>"   class="cmseasyedit"><?php echo $cat['catname'];?></span>
        </h4>
        <p>
            <span cmseasy-id="<?php echo $cat['catid'];?>"   class="cmseasyedit"><?php echo $cat['subtitle'];?></span>
        </p>

        <h5>
            <i class="icon-call-end"></i>：<span class="column-title cmseasyedit"   ><?php echo get('tel');?></span>
        </h5>
        <h5>
            <i class="icon-drop"></i>：<span class="column-title cmseasyedit"   ><?php echo get('address');?></span>
        </h5>
...
<style type="text/css">
    ...
    .contact-columns-right-2 {
        height:344px;
        background:#b22d2f;
        background-image:url("<?php echo $template_path;?>/visual/modules/common/contact-columns/images/contact-columns-right.png");
        background-size:cover;
    }
    .contact-columns-right a.more em{
        background-image:url("<?php echo $template_path;?>/visual/modules/common/contact-columns/images/contact-columns-right-ico.png");
    }
