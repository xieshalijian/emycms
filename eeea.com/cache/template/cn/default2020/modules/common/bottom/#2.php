...
<link href="<?php echo $template_path;?>/visual/modules/common/bottom/css/style-2.css" rel="stylesheet">
<div class="foot-ul foot-ul-2 foot-ul-2-2">

        <?php if(is_array(plugins::categoryinfo(16,20)))
foreach(plugins::categoryinfo(16,20) as $cat) { ?>
        <h4>
