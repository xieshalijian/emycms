    ...
    'use strict';
     ...
     $(document).ready(function(){
        ...
        $sidebar_content.on('click', '.navigation li a',function(){
            ...
            var listItemS= $this.parent('li').siblings();
            ...
            if(listItem.hasClass('has-sub') && listItem.hasClass('open')){
                ...
                for(var i=1;i<listItemS.length-1;i++){
                    if($(listItemS[i]).hasClass('has-sub') && $(listItemS[i]).hasClass('open')){
                        collapse($(listItemS[i]));
                    }
                }
...
var $subList = listItem.children('ul');
                    ...
                    listItem.siblings('.open').find('li.open').removeClass('active');
 ...
 var $subList = $listItem.children('ul');
            ...
            $subList.show().slideUp(400, function() {
                $(this).css('display', '');
