<link href="{$template_path}/visual/modules/common/job-columns-pic/css/style-3.css" rel="stylesheet">

{loop plugins::categoryinfo($_catid,$_titlenum,$_textnum) $cat}
<div class="job-columns-pic-item job-columns-pic-item3 job-columns-pic-item3-$_id">
...
<style type="text/css">
    .job-columns-pic-item3-$_id .job-columns-pic-text h4 a {
        font-size:$_link-font-size;
        color:$_link-color;
    }
    .job-columns-pic-item3-$_id .job-columns-pic-text h4 a:hover {
        color:$_link-hover-color;
    }
    .job-columns-pic-item3-$_id .job-columns-pic-text a.more {
        font-size:$_btn-size;
    ...
    .job-columns-pic-item3-$_id .job-columns-pic-text a.more:hover {
