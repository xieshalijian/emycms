<link href="{$template_path}/visual/modules/common/bottom/css/style-1.css" rel="stylesheet">
<div class="foot-ul foot-ul-1 foot-ul-1-$_id">
...
<style type="text/css">
    .foot-ul-1-$_id ul h4 a {
        font-size:$_title-size;
        color:$_title-color;
    }
    .foot-ul-1-$_id ul h4 a:hover {
        color:$_title-hover-color;
    }
    .foot-ul-1-$_id ul li a {
        font-size:$_subtitle-size;
        color:$_subtitle-color;
    }
    .foot-ul-1-$_id ul li a:hover {
