<link href="{$template_path}/visual/modules/common/two-columns-btn/css/style-1.css" rel="stylesheet">

{loop plugins::categoryinfo($_catid,$_titlenum,$_textnum) $cat}
<div class="two-columns-btn-item two-columns-btn-item-l two-columns-btn-item-l-$_id">
    <div class="two-columns-btn-title">
        <div class="two-columns-btn-title2">
            <a class="more" title="{$cat['catname']}" href="{$cat['url']}"><span class="glyphicon glyphicon-chevron-left"></span></a>
            <h4>
...
<style type="text/css">
    .two-columns-btn-item-l-$_id {
        background:$_background-color;
    }
    .two-columns-btn-item-l-$_id:hover {
        background:$_background-hover-color;
    }
    .two-columns-btn-item-l-$_id h4 a {
    ...
    .two-columns-btn-item-l-$_id:hover h4 a {
    ...
    .two-columns-btn-item-l-$_id .two-columns-btn-title a.more {
        font-size:$_btn-size;
    ...
    .two-columns-btn-item-l-$_id .two-columns-btn-title a.more:hover {
