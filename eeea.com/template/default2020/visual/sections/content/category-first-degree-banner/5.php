<link href="<?php echo $base_url;?>/template_admin/<?php echo config::getadmin('template_admin_dir');?>/visual/sections/content/category-first-degree-banner/css/style.css" rel="stylesheet">
