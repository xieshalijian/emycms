...
<div class="claerfix col-md-12">
    <p class="visual-print-tools visual-print-tools-$_id $_text-align">
...
<style type="text/css">
    ...
    .visual-print-tools-$_id {
        background:$_background-color;
    }
    .visual-print-tools-$_id:hover {
        background:$_background-hover-color;
    }

    .visual-print-tools-$_id a {
    ...
    .visual-print-tools-$_id a:hover {
