<link href="<?php echo $base_url;?>/template_admin/<?php echo config::getadmin('template_admin_dir');?>/visual/sections/type/content-list/css/style.css" rel="stylesheet">
<div class="content-list content-list-$_id">
    ...
    <ul>
        {loop archive(0,$typeid,'0','0,0,0','$_title-number','$_list-sort','$_list-number',false,'0',true,'0','0','$_intro-number','0') $i $archive}
