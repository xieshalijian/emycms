...
<div class="lyrow element-box position-move clearfix">
    ...
    <div class="preview">
        <img src="<?php echo $base_url;?>/template_admin/<?php echo get('template_admin_dir',true);?>/visual/sections/special/special-list/special-list.png">
        <p>{langadmin_list}</p>
    </div>
    <div class="view">
        <div class="tag">
            <span class="removeClean tagname">
                &#123;tag_sections_special_special-list_1&#125;
            </span>
            <!--组件演示开始-->
            {tag_sections_special_special-list_1}
            <!--组件演示结束-->
